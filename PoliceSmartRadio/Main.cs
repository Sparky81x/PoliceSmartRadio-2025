...
namespace PoliceSmartRadio
{
    internal class Main : Plugin
    {
        ...
        {
            Game.Console.Print("PoliceSmartRadio " + Assembly.GetExecutingAssembly().GetName().Version.ToString() + ", by Albo1125 updated by Sparky for LSPDFR 0.4.9, loaded successfully!");
